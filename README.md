...
To use the keywords of this library the Flex application has to be build with the Selenium-Flex API as a dependency.
...
For the list of available keywords go to
